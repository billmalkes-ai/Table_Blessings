...
const days = [
  {
    day: 1, arc: "Creation & Provision", theme: "The First Gift", reference: "Genesis 1:29–30",
    ...
    framing: "God prepared food for his creatures before they arrived to receive it. Provision was written into the order of creation on the very first day, settled before the first hunger was ever felt.",
  ...
  {
    day: 2, arc: "Creation & Provision", theme: "The God Who Tends", reference: "Psalm 104:14–15",
    ...
    framing: "God tends his creation still, season after season, drawing bread up from the ground with the same attentiveness he showed on the first day. A gardener at work is the right image for what this psalm describes.",
  ...
  {
    day: 3, arc: "Creation & Provision", theme: "A Garden Prepared", reference: "Genesis 2:8–9",
    ...
    framing: "The first home God made for his people was a garden. He intended from the beginning for nourishment and beauty to belong to each other, which is why a well-set table still feels like a kind of restoration.",
  ...
  {
    day: 4, arc: "Creation & Provision", theme: "Every Good Gift", reference: "James 1:17",
    ...
    framing: "Everything on this table descended, as all good things do, from a Father whose gifts are without limit or interruption. The food is one visible form of a generosity that runs through every good thing we have ever received.",
    prayer: ["Father of lights, we trace this meal back to you.", "Nothing good in our lives comes from any other source. Amen."]
  },
  {
    day: 5, arc: "Creation & Provision", theme: "The Lord Will Provide", reference: "Genesis 22:13–14",
    ...
    framing: "The name Abraham gave to that mountain is still true today. Jehovah-Jireh: the Lord who sees what is needed and provides before we reach the moment of need, often from a direction we would never have thought to look.",
  ...
  {
    day: 6, arc: "Creation & Provision", theme: "Eyes That Wait", reference: "Psalm 145:15–16",
    ...
    framing: "This psalm holds a quietly beautiful image: every living creature, from sparrows to families at dinner tables, turning its eyes upward at the hour of hunger. We are in that company every time we sit down to eat.",
  ...
  {
    day: 7, arc: "Creation & Provision", theme: "Food for All Flesh", reference: "Psalm 136:25–26",
    ...
    framing: "The refrain of this psalm repeats 26 times: his love endures forever. Feeding his creation is one of the primary ways that love makes itself known, tangible and daily and impossible to miss if we are paying attention.",
    prayer: ["Your love endures forever — and tonight it looks like this meal.", "We give thanks to the God of heaven. Amen."]
  },
  {
    day: 8, arc: "Wilderness & Daily Bread", theme: "Bread from Heaven", reference: "Exodus 16:14–15",
    ...
    framing: "A million hungry people in a wilderness, and God answered with something so strange they had no word for it. Manna means what is it, a name that admits complete dependence without requiring any explanation at all.",
  ...
  {
    day: 9, arc: "Wilderness & Daily Bread", theme: "Daily", reference: "Matthew 6:11",
    passage: "Give us this day our daily bread.",
    framing: "Jesus taught us to pray for today's bread. He intended us to return tomorrow and ask again, which means daily dependence is the rhythm he designed for us, the practice by which we remember who is actually doing the providing.",
    prayer: ["Lord, we are here again today, asking again.", "Thank you that you have never grown tired of that. Amen."]
  },
  {
    day: 10, arc: "Wilderness & Daily Bread", theme: "More Than Bread", reference: "Deuteronomy 8:3",
    ...
    framing: "God used the hunger as the lesson. He fed them with something unknown so they would learn that the voice commanding food into existence is the true source of life, and that the bread on the table points toward something deeper than the bread itself.",
  ...
  {
    day: 11, arc: "Wilderness & Daily Bread", theme: "Water from the Rock", reference: "Numbers 20:8, 11",
    ...
    framing: "In a land with no water, God put water inside a rock. He works entirely outside the ordinary logic of where provision comes from, which is a useful thing to remember when the cupboard looks thin.",
  ...
  {
    day: 12, arc: "Wilderness & Daily Bread", theme: "The Angel's Touch", reference: "1 Kings 19:5–6",
    ...
    framing: "Elijah was exhausted and fleeing, and God's first response was bread, water, and the instruction to rest. Sometimes provision is the most pastoral thing God offers, the form his care takes when what we need most is to be fed and told to sleep.",
    prayer: ["When we are worn out, you still set a table.", "Receive our thanks tonight — we needed this more than we may admit. Amen."]
  },
  {
    day: 13, arc: "Wilderness & Daily Bread", theme: "The Jar That Did Not Run Out", reference: "1 Kings 17:14–16",
    ...
    framing: "A widow with enough for one last meal found that the flour lasted three years. God makes small things endure past the point of reason, which is a pattern worth holding on to when our own resources look close to spent.",
  ...
  {
    day: 14, arc: "Wilderness & Daily Bread", theme: "The Finest Wheat", reference: "Psalm 81:16",
    passage: "But you would be fed with the finest of wheat; with honey from the rock I would satisfy you.",
    framing: "This is God speaking about what he wanted to give, what he was always ready to give. The finest wheat. Honey from the rock. He reserves the best for his people, and this table tonight is one small expression of that same desire.",
    prayer: ["You give us your finest, not your surplus.", "We sit at this table humbled by that generosity. Amen."]
  },
  {
    day: 15, arc: "Harvest & Abundance", theme: "First and Best", reference: "Deuteronomy 26:10",
    ...
    framing: "The firstfruits offering was an act of trust. You gave back the first and the best before you knew whether the rest would follow. That is what gratitude at a table looks like before you eat: the offering made while the outcome is still open.",
    prayer: ["We have not yet eaten, and we give thanks.", "This is our firstfruits — the gratitude before the meal. Amen."]
  },
  {
    day: 16, arc: "Harvest & Abundance", theme: "Leave Some Behind", reference: "Leviticus 19:9–10",
    ...
    framing: "God built generosity into the harvest law as a structural feature of how food was gathered. The edges of the field belonged to the poor before the harvest was ever complete, which means sharing was built in before the question of charity ever arose.",
    prayer: ["We eat tonight knowing there are edges we are meant to leave.", "Make us people who harvest with open hands. Amen."]
  },
  {
    day: 17, arc: "Harvest & Abundance", theme: "Seedtime and Harvest", reference: "Genesis 8:22",
    passage: "As long as the earth endures, seedtime and harvest, cold and heat, summer and winter, day and night will never cease.",
    framing: "After the flood, when the world began again, this was one of God's first promises: the rhythms of provision would hold. The seasons would keep turning. The harvest would keep coming. We eat tonight inside that covenant, still being kept.",
  ...
  {
    day: 18, arc: "Harvest & Abundance", theme: "The Earth Has Yielded", reference: "Psalm 67:6–7",
    ...
    framing: "Harvest is testimony. When the earth yields and we receive with gratitude, the nations see what kind of God is behind it. This table is a small act of witness, whether or not anyone outside this room is watching.",
    prayer: ["Let this table be a witness, even if only to ourselves.", "You bless us so we can declare you to the world. Amen."]
  },
  {
    day: 19, arc: "Harvest & Abundance", theme: "Multiplied for Generosity", reference: "2 Corinthians 9:10–11",
    ...
    framing: "God increases what we have so that the circle of generosity can grow wider. Abundance is enlarged capacity for giving, which means every meal with more than enough on the table is an invitation to pass something along.",
  ...
  {
    day: 20, arc: "Harvest & Abundance", theme: "The Generous Soul", reference: "Proverbs 11:24–25",
    ...
    framing: "Generosity is a structure built into the economy of God's world. The closed hand loses. The open hand fills. This proverb reads less like moral instruction and more like a description of how things actually work when God is the one keeping the accounts.",
    prayer: ["We receive this meal with open hands.", "Make our hands as open toward others as yours are toward us. Amen."]
  },
  {
    day: 21, arc: "Harvest & Abundance", theme: "The Years Restored", reference: "Joel 2:26",
    ...
    framing: "This is a promise made to a people who had watched the locusts take everything. God provides and he restores, which are two different things. He makes up the years the locusts ate, and some of us are eating tonight from ground he gave back.",
  ...
  {
    day: 22, arc: "Table Fellowship", theme: "The Tax Collector's Table", reference: "Luke 5:29–31",
    ...
    framing: "Jesus went directly to Levi's table. He sat down with the people others avoided and called it exactly where he needed to be. The table was where the healing happened, which is still true of tables where welcome is offered without reservation.",
  ...
  {
    day: 23, arc: "Table Fellowship", theme: "He Came to My House", reference: "Luke 19:5–6",
    ...
    framing: "Jesus looked up into a tree at a man the crowd had pushed to the margins and said I must stay at your house. The meal at Zacchaeus's table changed everything about Zacchaeus. That is what happens when the right guest crosses the threshold.",
    prayer: ["Come to our table as you came to his.", "We welcome you gladly. Amen."]
  },
  {
    day: 24, arc: "Table Fellowship", theme: "He Gave Thanks First", reference: "Luke 9:16",
    ...
    framing: "Jesus gave thanks for five loaves before the miracle unfolded. He thanked the Father as if those five loaves were already sufficient, which in his hands they were. Gratitude before sufficiency is what this sequence invites us to practice.",
  ...
  {
    day: 25, arc: "Table Fellowship", theme: "Known in the Breaking", reference: "Luke 24:30–31",
    ...
    framing: "They had walked with him for hours without recognition. Then he broke bread with that familiar gesture, and suddenly they knew. He is still made known at tables, which gives every ordinary meal a second layer of meaning.",
    prayer: ["Open our eyes tonight.", "Let us recognize you in the breaking of this bread. Amen."]
  },
  {
    day: 26, arc: "Table Fellowship", theme: "The Father Ran", reference: "Luke 15:22–24",
    passage: "But the father said to his servants, 'Quick! Bring the best robe and put it on him. Put a ring on his finger and sandals on his feet. Bring the fattened calf and kill it. Let's have a feast and celebrate. For this son of mine was dead and is alive again; he was lost and is found.' So they began to celebrate.",
    framing: "The feast was the father's first response to the son's return, begun before the apology was complete. That is the kind of welcome behind every meal we receive, a welcome more eager than anything we have done to deserve it.",
  ...
  {
    day: 27, arc: "Table Fellowship", theme: "One Thing Is Needed", reference: "Luke 10:41–42",
    ...
    framing: "Martha's distraction was the meal itself. Jesus called her back to presence, reminding her that the table is meant to gather people together, and that the one thing needed was already sitting in the room.",
    prayer: ["Let this meal gather us rather than distract us.", "May the one thing needed be present at this table tonight. Amen."]
  },
  {
    day: 28, arc: "Table Fellowship", theme: "In Remembrance", reference: "Luke 22:19–20",
    ...
    framing: "Every meal that follows this one carries something of this one inside it. The ordinary table was transformed that night, filled with a meaning it will carry forever. We eat in remembrance at every table we sit at, whether we say so aloud or not.",
    prayer: ["Every meal is an echo of this one.", "We do not take bread tonight without knowing what bread cost. Amen."]
  },
  {
    day: 29, arc: "The Eternal Table", theme: "Come, for Everything Is Ready", reference: "Luke 14:16–17",
    ...
    framing: "The great banquet of the Kingdom is already prepared and the invitation has already gone out. Every meal we share is a small rehearsal for the one that is waiting, practice for a feast that will have no last course.",
  ...
  {
    day: 30, arc: "The Eternal Table", theme: "The Feast That Has No End", reference: "Isaiah 25:6",
    ...
    framing: "This is where the story ends: a mountain, a feast, all peoples, and the very best of everything. We eat tonight in the direction of that day, thirty meals into a practice that will one day give way to the real thing.",
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <button
            onClick={() => current < 29 && goTo(current + 1)}
            disabled={current === 29}
            style={{
              background: current < 29 ? "#8B6914" : "transparent",
              border: "1px solid #8B6914",
              color: current < 29 ? "#FFF8E8" : "#8B691430",
              fontFamily: "'Cinzel', serif",
              fontSize: "9px",
              letterSpacing: "2px",
              padding: "10px 18px",
              cursor: current === 29 ? "default" : "pointer",
              borderRadius: "2px",
              textTransform: "uppercase",
              fontWeight: 500,
            }}
          >{current < 29 ? `Day ${current + 2} →` : "Fin"}</button>
        </div>
